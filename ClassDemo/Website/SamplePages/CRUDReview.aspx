                ...
                <div class="tab-pane fade in active" id="find">
                 ...
                 <div class="tab-pane fade" id="lvmaintain">
                      <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                           <asp:ListView ID="AlbumCRUD" runat="server" DataSourceID="AlbumCRUDODS" InsertItemPosition="LastItem">
            ...
            <tr style="background-color: #FFFFFF; color: #284775;">
                ...
                <td>
                    <asp:DropDownList ID="ArtistListlV" runat="server" 
                        ...
                        DataValueField="ArtistId" 
                        selectedvalue="'<%# Eval("ArtistId") %>'" Width="250px">
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <tr style="background-color: #999999;">
                ...
                <td>
                    <asp:DropDownList ID="ArtistListlV" runat="server" 
                        DataSourceID="ArtistListODS" DataTextField="Name" 
                        DataValueField="ArtistId" 
                        selectedvalue="'<%# Bind("ArtistId") %>'"Width="250px">
                    </asp:DropDownList>
                <td>
            ...
            <tr style="background-color: #E2DED6; font-weight: bold; color: #333333;">
                ...
                <td>
                    <asp:Label Text='<%# Eval("ReleaseLabel") %>' runat="server" ID="ReleaseLabelLabel" /></td>
                            ...
                            <asp:ObjectDataSource ID="AlbumCRUDODS" runat="server" DataObjectTypeName="Chinook.Data.Enitities.Album" 
                              DeleteMethod="Albums_Delete" 
                              InsertMethod="Albums_Add" 
                              OldValuesParameterFormatString="original_{0}"
                              SelectMethod="Albums_List" 
                              TypeName="ChinookSystem.BLL.AlbumController"
                              UpdateMethod="Albums_Update" OnSelected="CheckForException" 
                              OnDeleted="CheckForException"
                              OnInserted="CheckForException" 
                              OnUpdated="CheckForException"></asp:ObjectDataSource>

                            <!--This ODS already exists in tab 2, therefore i do not need to recreate for this tab
                                If the tab was on a page by itself, then i would not neeed to create the ArtistList ODS -->
